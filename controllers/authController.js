...
const loginUser = async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ username: user.username,token, email:user.email,verified: user.verified});
};
...
export { registerUser, loginUser, verifyUser, forgotPassword,changePassword,checkUserToken };
